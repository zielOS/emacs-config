...
(efs/leader-keys
  ...
  "h f" '(helpful-callable :which-key "helpful callable")
  "h v" '(helpful-callable :which-key "helpful variable")
  "h k" '(helpful-callable :which-key "helpful key")
  "h x" '(helpful-callable :which-key "helpful command")
...
#+begin_src emacs-lisp
  (use-package tex
    ...
    (efs/leader-keys
     ...
     "b e" '(reftex-citation :wk "Enter reftex citation")
...
#+begin_src emacs-lisp
  ...
  (setq gc-cons-threshold (* 2 5000 1000))
#+end_src
