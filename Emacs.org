...
(defun efs/set-font-faces ()
  ...
  (set-face-attribute 'default nil :font "JetBrainsMono Nerd Font" :height 95)

  ;; Set the fixed pitch face
  (set-face-attribute 'fixed-pitch nil :font "JetBrainsMono Nerd Font" :height 95)

  ;; Set the variable pitch face
  (set-face-attribute 'variable-pitch nil :font "JetBrainsMono Nerd Font" :height 95 :weight 'regular))
...
#+begin_src emacs-lisp
    (use-package tex
      ...
      (efs/leader-keys
       ...
       "C-e" '(LaTeX-environment :wk "enter LaTeX environment")
       "c t" 'orgtbl-mode))
#+end_src
** Import *.sty
...
#+begin_src emacs-lisp
  (use-package helm-bibtex
    ...
    :after (org-ref)
    :init
    (efs/leader-keys "fB" 'helm-bibtex))

  (add-hook 'bibtex-mode 'smartparens-mode)

  (autoload 'helm-bibtex "helm-bibtex" "" t)
  (setq bibtex-completion-bibliography
        '("~/Documents/Papers/Information_Processing/main.bib"))
#+end_src
