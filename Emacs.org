...
#+RESULTS:
| turn-on-auto-fill | turn-on-flyspell | turn-on-prettify-symbols-mode | citar-capf-setup |
...
(use-package org-modern
  :vc (:fetcher github :repo "minad/org-modern"))
...
(use-package org-modern-indent
  ...
  (add-hook 'org-mode-hook #'org-modern-indent-mode 60))
#+end_src
