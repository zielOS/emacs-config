...
(defun efs/org-font-setup ()
  ...
  ;; straight that anything that should be fixed-pitch in Org files appears that way
...
#+RESULTS:
| rainbow-delimiters-mode | org-src-babel-configure-edit-buffer | org-src-mode-configure-edit-buffer |
